namespace Aide.Winforms {
  partial class CommonCreateEditGroupForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      ...
      this.Name = "CommonCreateEditForm";
      this.Text = "Common Create Edit Form";
      this.Load += new System.EventHandler(this.CommonCreateEditForm_Load);
      this.Shown += new System.EventHandler(this.CommonCreateEditForm_Shown);
